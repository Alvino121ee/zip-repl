...
import ForexPro from "@/pages/ForexPro";
import CryptoPro from "@/pages/CryptoPro";
  ...
  return (
    <AppLayout>
      <Switch>
        ...
        <Route path="/forex-pro" component={ForexPro} />
        <Route path="/crypto-pro" component={CryptoPro} />
